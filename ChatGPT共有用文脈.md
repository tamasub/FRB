...
見えないものを、可視化し、構造化し、共有する文化をつくる

FRB
→ ロッドの感度という見えないものを、振動として可視化した

思考拡張
→ 違和感という見えないものを、パターンとして構造化した

AI駆動開発
→ 生成速度と承認速度のズレという見えないものを、Diffとして可視化した

AI承認駆動開発
→ 判断という見えないものを、判断軸・制約として構造化した
...
├─ 目的（何を実現したいか）
├─ 背景（なぜこの状況に至ったか）
└─ 方針（判断を評価する上位の考え方。目的関数的な最適化方向も含む）
