...
// v0.18.63-initial-json-message:
// Data未読込時もJSON Object Studioの目的を示す表示専用タイトル。
// currentLoadedDataTitle自体には混ぜず、Data/Related Grid等の内部意味を汚さない。
const JSON_STUDIO_INITIAL_DATA_TITLE = "JSONを、AIとの共通言語に。―― 構造化されたJSONで、AIとの成果物循環をもっと密に。";
...
function renderCurrentLoadedDataDisplay() {
  ...
  const actualTitle = String(currentLoadedDataTitle || '').trim();
  const title = actualTitle || JSON_STUDIO_INITIAL_DATA_TITLE;
