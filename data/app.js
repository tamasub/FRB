...
const BANDS_INVESTIGATE = [
  ...
  { key:'b2_5', label:'80-100',   f0:80,  f1:100 }, // ★追加

  { key:'b3',   label:'100-120',  f0:100, f1:120 },
  { key:'b4',   label:'120-160',  f0:120, f1:160 },

  { key:'b4_5', label:'160-220',  f0:160, f1:220 }, // ★追加
...
const BANDS_INVESTIGATE_LEGEND = [
  ...
  ['b2_5', '80-100Hz',  '中低域ブリッジ'], // ★追加

  ['b3',   '100-120Hz', '翻訳帯域'],
  ['b4',   '120-160Hz', '中域キャラクター'],

  ['b4_5', '160-220Hz', '中域→高域ブリッジ'], // ★追加
...
const BAND_COLORS_INVESTIGATE = [
  ...
  '#4dd0e1', // 80-100 ★追加（60-80とのグラデ中間）

  '#43a047', // 100-120
  '#c0ca33', // 120-160

  '#d4e157', // 160-220 ★追加（中域→高域つなぎ）
